...
export default function LandingPage() {
  ...
  return (
    <main className="relative min-h-screen bg-[#F9F9F7] text-[#1a1a1a] selection:bg-black selection:text-white overflow-x-hidden font-serif">
      ...
      {/* Curseur Cœur */}
      <div
        className="pointer-events-none fixed z-[100] transition-transform duration-75 ease-out hidden md:block mix-blend-multiply"
        style={{
      ...
      >
        <Heart fill="black" stroke="none" className="w-5 h-5" />
      </div>
